...
rem Delete old
del ".\bin\x86\Debug\Sample File Writing.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x86\[YourApplicationExeFile].exe.manifest ".\bin\x86\Debug\Sample File Writing.exe.manifest" /y 
