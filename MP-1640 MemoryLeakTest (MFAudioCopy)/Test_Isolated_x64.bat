...
rem rem Delete old
del ".\bin\x64\Debug\Sample File Writing.exe.manifest" /f /q
...
copy ..\..\..\Bin\Manifests\x64\[YourApplicationExeFile].exe.manifest ".\bin\x64\Debug\Sample File Writing.exe.manifest" /y 

rem Run
cd .\bin\x64\Debug
"Sample File Writing.exe"
