...
namespace SampleFileWriting
{
    public partial class Form1 : Form
    {
        ...
        private void comboBoxAudioEx2_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                m_objLive.DeviceSet(eMFDeviceType.eMFDT_ExtAudio_2, comboBoxAudioEx2.SelectedIndex, "");
            }
            catch { }
        }
    }
