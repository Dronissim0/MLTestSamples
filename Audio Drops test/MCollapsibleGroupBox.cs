...
namespace MControls
{
	...
	public class MCollapsibleGroupBox : GroupBox
	{
		...
		{
			if (IsCollapsed)
                g.DrawImage(SampleFileWriting.Properties.Resources.plus, m_toggleRect);
			else
                g.DrawImage(SampleFileWriting.Properties.Resources.minus, m_toggleRect);
		}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(MControls.MCollapsibleGroupBox));
			this.SuspendLayout();
			// 
			// CollapsibleGroupBox
			// 
